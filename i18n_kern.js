...
(function (root, factory) {
  ...
  var D = {
    ...
    uiGeruest:    { de: 'Nur was zur Auswahl passt, wird abgefragt. „Berechnen" prüft die Eingaben und rechnet dann. Rechenweg und Nahtbild-Grafik folgen in Etappe N5c-2.',
                    en: 'Only what fits the selection is asked for. "Calculate" checks the entries and then computes. Calculation path and weld drawing follow in stage N5c-2.',
                    pt: 'Só é pedido o que corresponde à seleção. «Calcular» verifica as entradas e depois calcula. O percurso de cálculo e o desenho seguem na etapa N5c-2.' },
